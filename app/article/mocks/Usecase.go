...
func (_m *Usecase) Create(_a0 model.ArticleModel) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *Usecase) FindAll() ([]model.ArticleModel, error) {
	ret := _m.Called()
...
func (_m *Usecase) FindOne(id string) (model.ArticleModel, error) {
	ret := _m.Called(id)
...
func (_m *Usecase) Update(id string, _a1 model.ArticleModel) error {
